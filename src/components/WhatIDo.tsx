      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            <div className="what-border1">
              <svg height="100%">
                {/* Top border shared with container, Bottom border added */}
                <line
                  x1="0"
                  y1="0"
                  x2="100%"
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>{config.skills.professional.title}</h3>
              <h4>{config.skills.professional.description}</h4>
              <p>{config.skills.professional.details}</p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                {config.skills.professional.tools.map((tool, index) => (
                  <div key={index} className="what-tags">
                    {tool}
                  </div>
                ))}
